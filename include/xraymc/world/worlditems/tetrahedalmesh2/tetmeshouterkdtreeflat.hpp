...
class TetMeshOuterKDTreeFlat {
public:
    TetMeshOuterKDTreeFlat() { };
    TetMeshOuterKDTreeFlat(const std::vector<std::array<double, 3>>& vertices, const std::vector<std::array<std::uint32_t, 3>>& elements, std::uint32_t max_depth = 8)
    {
